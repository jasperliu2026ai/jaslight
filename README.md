...
[![Version](https://img.shields.io/badge/version-2.0.0-orange)](https://github.com/jasperliu2026ai/jaslight/releases)
...
| 系统 | 文件 | 说明 |
|---|---|---|
| macOS Apple 芯片 (M1/M2/M3/M4) | `JasLight-2.0.0-arm64.dmg` | 推荐 |
| macOS Intel | `JasLight-2.0.0.dmg` | macOS 11+ |
| Windows 安装版 | `JasLight Setup 2.0.0.exe` | 可选安装路径 |
| Windows 免安装版 | `JasLight 2.0.0.exe` | 单文件绿色版 |
...
| OS | File | Notes |
|---|---|---|
| macOS Apple Silicon (M1/M2/M3/M4) | `JasLight-2.0.0-arm64.dmg` | Recommended |
| macOS Intel | `JasLight-2.0.0.dmg` | macOS 11+ |
| Windows installer | `JasLight Setup 2.0.0.exe` | Choose install path |
| Windows portable | `JasLight 2.0.0.exe` | Single-file, no install |
